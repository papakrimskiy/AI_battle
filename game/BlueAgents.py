...
from game.ImageRect import ImageRect
from game.SharedKnowledge import SharedKnowledge
...
class BlueMeleeAgent:
    ...
    def get_state(self, red_base, blue_base, red_agents, blue_agents, obstacles):
        ...
        return {
            ...
            'enemy_base_position': red_base.rect.center,
            'ally_base_position': blue_base.rect.center,
            'enemy_positions': [agent.image.rect.center for agent in red_agents if agent.is_alive()],
            'ally_positions': [agent.image.rect.center for agent in blue_agents if agent.is_alive()],
            'obstacles': obstacles
        }
